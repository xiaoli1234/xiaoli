...
public class FileChooserAdapter1 extends BaseAdapter {
    ...
    public FileChooserAdapter1(Context context, ArrayList<FileInfo> fileLists) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(fileInfo.isDirectory()){      //文件夹
            holder.imgFileIcon.setImageResource(R.drawable.v1_project);
            holder.tvFileName.setTextColor(Color.GRAY);
        }
        else if(fileInfo.isPPTFile()){   //PPT文件
            holder.imgFileIcon.setImageResource(R.drawable.v1_file_shp);
            holder.tvFileName.setTextColor(Color.RED);
        }
		else {                           //未知文件
			holder.imgFileIcon.setImageResource(R.drawable.wufa);
			holder.tvFileName.setTextColor(Color.GRAY);
		}
        return view;
    }
