...
public class FileChooserActivity1 extends Activity {
    ...
    private ArrayList<FileChooserAdapter1.FileInfo> mFileLists  ;
    private FileChooserAdapter1 mAdatper ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSdcardRootPath = Environment.getExternalStorageDirectory().getAbsolutePath()+"/ydqt";// �õ�sdcardĿ¼
    ...
    private void setGridViewAdapter(String filePath) {
        ...
        mAdatper = new FileChooserAdapter1(this , mFileLists);
    ...
    private void updateFileItems(String filePath) {
        ...
        if(mFileLists == null)
            mFileLists = new ArrayList<FileChooserAdapter1.FileInfo>() ;
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            FileChooserAdapter1.FileInfo fileInfo = new FileChooserAdapter1.FileInfo(fileAbsolutePath , fileName , isDirectory) ;
    ...
    private OnItemClickListener mItemClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> adapterView, View view, int position,
                                long id) {
            FileChooserAdapter1.FileInfo fileInfo = (FileChooserAdapter1.FileInfo)(((FileChooserAdapter1)adapterView.getAdapter()).getItem(position));
            if(fileInfo.isDirectory())   //点击项为文件夹, 显示该文件夹下所有文件
                updateFileItems(fileInfo.getFilePath()) ;
            else if(fileInfo.isPPTFile()){  //是ppt文件 ， 则将该路径通知给调用者
                Intent intent1 = new Intent();
                intent1.putExtra(MainActivity.EXTRA_FILE_CHOOSER , fileInfo.getFilePath());
