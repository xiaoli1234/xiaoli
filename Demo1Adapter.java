...
public class Demo1Adapter extends BaseAdapter {
	 ...
	 * 数据集合
	 */
	private List<Demo1Bean> datas = null;
	...
	public Demo1Adapter(Context context, List<Demo1Bean> datas) {
		this.datas = datas;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		 ...
		 */
		if (convertView == null) {
			layout = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.listview_item_layoutb, parent, false);
		} else {
			layout = (ViewGroup) convertView;
		}

		Demo1Bean bean = datas.get(position);
	 ...
	 * 增加一项的时候
	 */
	public void add(Demo1Bean bean) {
	...
	public List<Demo1Bean> getDatas() {
		return datas;
	}
